...
// taken from https://medium.com/medwing-engineering-product-design/hacking-next-js-for-better-pagespeed-scores-6c651d19f218
    ...
    `;
        ...
        return (
            <>
                ...
                <script id="__NEXT_SCRIPT_CUSTOM" dangerouslySetInnerHTML={{ __html: jsContent }} />
            </>
        );
    }
}
